...
.jumbotron {
    ...
    @include('frontend.audio.ifram.style')
...
<div class="container" style="margin-top:30px">
  ...
  <main role="main" id="mp3">
       ...
       <section class="jumbotron text-center" style="background:#cce6ff">
         <div class="container">
           <h1 class="jumbotron-heading" style="font-weight:bolder; color:#ffffff"> Dharmadeshana List  ... <i class="fa fa-audio-description" style='font-size:48px;color:#d29a18'></i></h1>
         </div>
       </section>
           ...
           <div class="row">
             ...
             @foreach ($audio as $key => $item)
               ...
               <div class="card p-3  box-shadow mb-2 mr-4" >
                 ...
                 <img class="card-img-top" style="height:110px" src="{{ url('audio/image/'.$item->image_path) }}" alt="Card image cap">
                
                 <div class="card-body ">
 
                   <marquee style="font-family:Book Antiqua; color: #FFFFFF" bgcolor="#212529" scrolldelay="200">{{ $item->id }}  -----  {{ $item->heading_name }}  </marquee>
                 ...
                 <audio id="myTune{{$key}}" controls controlsList="nofullscreen nodownload noremoteplayback">
                   ...
                   <div class="d-flex  justify-content-between align-items-center ">
                     ...
                     <div class="btn-group" style="width: 50%" >
                       ...
                       @include('frontend.audio.ifram.table')
                 </div>
               </div>
