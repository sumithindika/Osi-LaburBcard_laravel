...
<div class="card mb-4 wow fadeIn">
  <div class="card-body d-sm-flex justify-content-between">
    ...
    <a href="{{url('category-add')}}" class="badge btn btn-primary text-white py-2 float-right">Add Category</a>
    <a href="{{url('category-delete-record')}}" class="badge btn btn-danger text-white  py-2  float-right">Deleted Record</a>
